...
private:
    ...
    ExtrusionEntityCollection   m_ironings;
...
public:
    ...
    // pp ironings are created after fills. TODO: should be LayerExtrusionRange like perimeters, or ExtrusionRange like thin_fills? I guess there is only one region inside, right?
    LayerExtrusionRanges  ironings;
    // Region that is to be filled with the fills above (thin fills, regular fills, ironings?).
